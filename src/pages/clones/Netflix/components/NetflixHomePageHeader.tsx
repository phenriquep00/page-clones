...
export function NetflixHomePageHeader() {
    ...
    return (
        <header className="flex h-20 w-full align-middle items-center md:px-14 px-5 flex-row justify-between">
            <div className="flex flex-row md:gap-12 gap-6"> {/* HeaderLeft */}
                ...
                <div className="flex flex-row md:gap-5 gap-2 md:text-[14px] text-xs text-white font-medium align-middle mt-1"> {/* MenuItems */}
                    <a href="#" className="font-black">Username</a>
                    <a href="#">Series</a>
                    <a href="#">Movies</a>
            ...
            <div className="flex flex-row md:gap-5 gap-2  text-white md:text-[14px] text-xs align-middle h-8 justify-center"> {/* HeaderRight */}
                <div className="mt-1 flex flex-row gap-5">
                    <a href="#"><MagnifyingGlass size={20} weight='bold' /></a>
                    <a href="#"><p>pedro</p></a>
                    <a href="#"><Gift size={20} /></a>
                    <a href="#"><Bell size={20} weight='fill' /></a>
                </div>

                <div className="flex flex-row md:gap-3 gap-1">
                    <img src={black_white} alt="black and white squares" className="pr-3" />
                    <a href="#"><CaretDown size={20} color="#ffffff" weight="fill" /></a>
